...
class SimulationConfig:
    ...
    # Legacy compatibility fields: vehicle_fixed_* are unused in the PyVRP
    # objective (fixed route costs are zero). Overqualification is applied
    # as additive edge distance in model_builder when Skill_k > Req_j.
    ...
    # Why: optional real Open-Meteo hourly series (7d past + 7d forecast CSV).
    # When set, weather/lighting follow this file instead of Markov / lighting_cycle.
    open_meteo_hourly_csv: Optional[str] = None
    # Why: optional BBBike map file for real-world task spatial sampling.
    # Supports legacy .osm.csv.xz and full .osm.xz exports.
    bbbike_xz_path: Optional[str] = None
    bbbike_sampling_pool_size: int = 20000

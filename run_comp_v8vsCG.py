...
run_comp_v8vsCG.py
------------------
Paired comparison for v8 with service-level constrained deployment.
"""
...
if __name__ == "__main__":
    ...
    print(
        f"service rule : min_dispatch={base.deployment_min_dispatch_rate:.1%}, "
        f"max_backlog={base.deployment_max_backlog_ratio:.1%}, "
        f"met={decision.meets_service_constraints}"
    )
